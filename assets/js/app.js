...
const app = {
  ...
  anki: {
    ...
    renderBatchSelector() {
      ...
      const activeClass = "px-2.5 py-1 rounded-md transition-all text-xs font-mono font-bold bg-emerald-600 text-white shadow-sm";
    ...
    sendReportEmail() {
      ...
      const subject = `[AP2-FISI-Lernkarten] Feedback/Fehler: ${p.topicTitle} (${p.cardId})`;
      const bodyLines = [
        "Hallo Christoph,",
        "",
        "ich habe einen Fehler bzw. Feedback zu einer Lernkarte im AP2 FISI Tracker:",
        "",
        "--------------------------------------------------",
        ...
        p.feedback,
        "",
        "Gesendet aus dem AP2 FISI Tracker (Web/PWA)",
      ];
