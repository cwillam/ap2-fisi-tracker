...
window.ANKI_QUESTIONS = {
  ...
  '2.2': [
    ...
    { id: '2.2.2_4', q: 'Wofür steht die Abkürzung PoE (Power over Ethernet)?', a: 'Stromversorgung von Netzwerkgeräten (z.B. IP-Telefone, Kameras, APs) direkt über das Datenkabel (Twisted Pair).' },
    ...
    { id: '2.2.2_6', q: 'Was beschreibt the "Dämpfung" bei einem Übertragungsmedium?', a: 'Der Verlust an Signalstärke über die Länge des Kabels. Sie begrenzt die maximale Reichweite (z.B. max. 100m bei Kupfer-Ethernet).' },
