...
window.ANKI_QUESTIONS = {
  ...
  '1.2': [
    ...
    { id: '1.2.7_3', q: 'Was ist der Unterschied zwischen "Reaktionszeit" und "Wiederherstellungszeit"?', a: 'Reaktionszeit: Zeit bis zur ersten Rückmeldung/Beginn der Arbeit. Wiederherstellungszeit: Zeit bis der Service wieder voll funktionsfähig zur Verfügung steht.' },
    ...
    { id: '1.2.7_5', q: 'Was beschreibt der Begriff "Servicezeit" (Business Hours) in einem SLA?', a: 'Der Zeitraum, in dem der Dienstleister den Service garantiert (z.B. Mo-Fr, 08:00 - 17:00 Uhr). Ausfälle außerhalb dieser Zeit zählen nicht gegen das SLA.' },
    ...
    { id: '1.2.7_10', q: 'Was ist der Unterschied zwischen einem kundenbezogenen und einem servicebezogenen SLA?', a: 'Kundenbezogen: Ein SLA für alle Services eines Kunden. Servicebezogen: Ein SLA für einen bestimmten Service (z.B. E-Mail), der für alle Kunden gleich gilt.' },

    // --- 1.2.8 Lizenzrecht (10 Karten) ---
    { id: '1.2.8_1', q: 'Was ist das Kernmerkmal einer OEM-Lizenz?', a: 'Original Equipment Manufacturer. Die Software ist an eine bestimmte Hardware gebunden und wird oft ohne direkten Herstellersupport günstiger verkauft.' },
    ...
    { id: '1.2.8_4', q: 'Was ist der Vorteil einer Volumenlizenz (z.B. Microsoft Open Value)?', a: 'Einfache Verwaltung über ein Portal, Reimaging-Rechte, Zweitnutzungsrechte (Laptop) und oft die Möglichkeit zur Ratenzahlung oder Software Assurance.' },
    ...
    { id: '1.2.8_7', q: 'Welche Freiheit gewährt die GPL (GNU General Public License)?', a: 'Sie erlaubt das Nutzen, Studieren, Ändern und Weitergeben der Software, verpflichtet aber dazu, Änderungen unter derselben Lizenz zu veröffentlichen (Copyleft-Prinzip).' },
    { id: '1.2.8_8', q: 'Was ist "Proprietäre Software"?', a: 'Software, bei der der Quellcode geheim bleibt und die Nutzung durch den Hersteller stark eingeschränkt ist (Gegenteil von Open Source).' },
    { id: '1.2.8_9', q: 'Darf man in Deutschland "gebrauchte" Softwarelizenzen weiterverkaufen?', a: 'Ja, laut EuGH-Urteil ist dies legal, sofern die ursprüngliche Kopie unbrauchbar gemacht wurde (Erschöpfungsgrundsatz).' },
    { id: '1.2.8_10', q: 'Was beschreibt eine "Site License" (Standortlizenz)?', a: 'Eine Lizenz, die es erlaubt, eine Software an einem bestimmten physischen Standort auf beliebig vielen Rechnern zu installieren.' },
    ...
    { id: '1.3.1_3', q: 'Was ist der Unterschied zwischen einem Backup und einer Archivierung?', a: 'Backup: Kurz-/mittelfristige Kopie zur Wiederherstellung bei Datenverlust. Archivierung: Langfristige, meist unveränderbare Aufbewahrung (revisionssicher) aus rechtlichen Gründen.' },
    { id: '1.3.1_4', q: 'Warum ist ein "Air Gap" beim Backup heute so wichtig?', a: 'Eine physische oder logische Trennung des Backups vom restlichen Netzwerk schützt die Sicherungen vor Ransomware, die sich sonst auch im Backup-Speicher ausbreiten würde.' },
    { id: '1.3.1_5', q: 'Was beschreibt der Begriff "Immutability" (Unveränderbarkeit) bei Backups?', a: 'Ein Schutzmechanismus (oft WORM), der verhindert, dass geschriebene Backups für einen definierten Zeitraum gelöscht oder verändert werden können (Schutz vor Insider-Bedrohungen und Ransomware).' },
    { id: '1.3.1_6', q: 'Welche Aufgabe hat der "Backup-Server" in einer Backup-Infrastruktur?', a: 'Er steuert die Sicherungsaufträge, verwaltet die Metadaten (Katalog) und koordiniert die Datenströme zwischen Quelle und Ziel.' },
    { id: '1.3.1_7', q: 'Was ist ein "Pull-Backup" im Gegensatz zum "Push-Backup"?', a: 'Pull: Der Backup-Server holt sich die Daten aktiv vom Client (sicherer). Push: Der Client schickt die Daten aktiv an den Backup-Server.' },
    { id: '1.3.1_8', q: 'Warum sollte ein Backup-Konzept regelmäßig getestet werden (Restore-Test)?', a: 'Ein Backup ist wertlos, wenn die Wiederherstellung im Ernstfall nicht funktioniert. Tests finden defekte Medien oder fehlerhafte Konfigurationen rechtzeitig.' },
    { id: '1.3.1_9', q: 'Was ist der Zweck eines "Offsite-Backups"?', a: 'Schutz vor physischen Katastrophen am Hauptstandort (Brand, Diebstahl, Überschwemmung) durch räumliche Trennung der Daten.' },
    { id: '1.3.1_10', q: 'Was beschreibt die "Aufbewahrungsfrist" (Retention Policy)?', a: 'Festlegung, wie lange Sicherungskopien vorgehalten werden müssen, bevor sie überschrieben oder gelöscht werden dürfen.' },
    ...
    { id: '1.3.2_2', q: 'Wie funktioniert eine Inkrementelle Sicherung?', a: 'Es werden nur die Daten gesichert, die sich seit der LETZTEN Sicherung (egal welchen Typs) geändert haben. Vorteil: Kleinste Datenmenge. Nachteil: Langsamster Restore (alle Inkremente nötig).' },
    { id: '1.3.2_3', q: 'Wie funktioniert eine Differenzielle Sicherung?', a: 'Es werden alle Daten gesichert, die sich seit der letzten VOLL-Sicherung geändert haben. Sicherungsmenge wächst bis zum nächsten Full-Backup an.' },
    { id: '1.3.2_4', q: 'Welche Medien werden für einen Restore bei einer differenziellen Sicherung benötigt?', a: 'Nur die letzte Voll-Sicherung und die aktuellste differenzielle Sicherung.' },
    { id: '1.3.2_5', q: 'Was ist ein "Synthetic Full Backup"?', a: 'Der Backup-Server erstellt aus einem alten Full-Backup und den vorhandenen Inkrementen ein neues Voll-Backup, ohne die Daten erneut vom Client lesen zu müssen (entlastet Netzwerk).' },
    { id: '1.3.2_6', q: 'Erkläre den Begriff "Image-Level Backup" im Vergleich zum "File-Level Backup".', a: 'File-Level sichert einzelne Dateien/Ordner. Image-Level sichert die gesamte Partition/Festplatte als Block-Abbild (ermöglicht Bare-Metal-Recovery).' },
    ...
    { id: '1.3.2_8', q: 'Was bewirkt der VSS-Dienst (Volume Shadow Copy Service) unter Windows beim Backup?', a: 'Er ermöglicht die Sicherung von Dateien, die gerade im Zugriff sind oder von Anwendungen gesperrt werden (konsistente Sicherung im laufenden Betrieb).' },
    ...
    { id: '1.3.2_10', q: 'Welche Sicherungsmethode hat die geringste Belastung für das Produktionsnetzwerk?', a: 'Die inkrementelle Sicherung, da sie die geringste Datenmenge überträgt.' },
    ...
    { id: '1.3.3_2', q: 'Was bedeutet die Abkürzung RTO (Recovery Time Objective)?', a: 'Maximal tolerierbare Ausfallzeit. Die Zeit, die von der Störung bis zur vollständigen Wiederherstellung des Services vergehen darf (Wie lange darf die IT stillstehen?).' },
    { id: '1.3.3_3', q: 'Welchen Einfluss hat ein RPO von "Null" auf die Backup-Infrastruktur?', a: 'Es erfordert eine permanente, synchrone Spiegelung der Daten in Echtzeit (Continuous Data Protection), da keinerlei Datenverlust erlaubt ist.' },
    { id: '1.3.3_4', q: 'Warum ist ein sehr niedriges RTO meist sehr teuer?', a: 'Es erfordert hohe Investitionen in schnelle Hardware, automatisierte Failover-Cluster und redundante Systeme, um die Wiederherstellungszeit zu minimieren.' },
    { id: '1.3.3_5', q: 'Wie hängen RPO und das Sicherungsintervall zusammen?', a: 'Das Sicherungsintervall darf maximal so groß wie das RPO sein. Wenn RPO = 4 Stunden, muss mindestens alle 4 Stunden gesichert werden.' },
    { id: '1.3.3_6', q: 'Was beschreibt der Begriff "MTPD" (Maximum Tolerable Period of Disruption)?', a: 'Der absolut maximale Zeitraum, den ein Geschäftsprozess unterbrochen sein darf, bevor die Existenz des Unternehmens gefährdet ist (liegt meist über dem RTO).' },
    { id: '1.3.3_7', q: 'Wer legt die Werte für RPO und RTO fest?', a: 'Die Geschäftsführung (Business-Seite) basierend auf einer Business Impact Analyse (BIA), nicht die IT allein.' },
    { id: '1.3.3_8', q: 'Was versteht man unter "WRT" (Work Recovery Time)?', a: 'Die Zeit, die nach der technischen Wiederherstellung benötigt wird, um Daten zu prüfen, Konsistenzchecks zu machen und die Nutzer wieder arbeiten zu lassen.' },
    ...
    { id: '1.3.3_10', q: 'Was ist der Unterschied zwischen Disaster Recovery und Business Continuity?', a: 'Disaster Recovery: Fokus auf die technische Wiederherstellung der IT. Business Continuity: Fokus auf die Aufrechterhaltung der gesamten Geschäftsprozesse (auch ohne IT).' },

    // --- 1.3.4 Speichermedien (10 Karten) ---
    { id: '1.3.4_1', q: 'Was ist der Kernvorteil von LTO-Magnetbändern (Tapes) für die Langzeitarchivierung?', a: 'Sehr geringe Kosten pro Terabyte, extrem lange Lebensdauer (bis zu 30 Jahre) und die Möglichkeit der physischen Trennung vom Netz (Offline-Speicher).' },
    ...
    { id: '1.3.4_3', q: 'Erkläre der Backup-Ansatz "Disk-to-Disk-to-Tape" (D2D2T).', a: 'Daten werden zuerst schnell auf Festplatten gesichert (schneller Restore) und später zur langfristigen Aufbewahrung auf Tapes ausgelagert (kostengünstig/sicher).' },
    { id: '1.3.4_4', q: 'Was ist eine "Tape Library"?', a: 'Ein automatisiertes Speichersystem, das mehrere Bandlaufwerke und viele Tape-Slots enthält. Ein Roboterarm wechselt die Bänder automatisch nach Bedarf.' },
    { id: '1.3.4_5', q: 'Nenne einen Nachteil von Cloud-Backup gegenüber lokalem Backup.', a: 'Die Abhängigkeit von der Internet-Bandbreite (besonders beim ersten Vollbackup oder einem großen Restore) und die laufenden Kosten für den Speicherplatz.' },
    { id: '1.3.4_6', q: 'Welche Aufgabe hat das "Cleaning Tape" bei LTO-Laufwerken?', a: 'Die automatische Reinigung der Schreib-/Leseköpfe des Laufwerks zur Vermeidung von Fehlern durch Abrieb oder Staub.' },
    { id: '1.3.4_7', q: 'Was beschreibt der Begriff "VTL" (Virtual Tape Library)?', a: 'Ein Festplattensystem, das sich gegenüber der Backup-Software wie ein Bandlaufwerk verhält. Kombiniert die Geschwindigkeit von Disks mit der Logik von Tapes.' },
    { id: '1.3.4_8', q: 'Warum ist Verschlüsselung bei Backup-Medien (besonders Tapes) essenziell?', a: 'Da Tapes oft transportiert oder extern gelagert werden, schützt Verschlüsselung die Daten bei Verlust oder Diebstahl des physischen Mediums.' },
    ...
    { id: '1.3.4_10', q: 'Was ist der Unterschied zwischen einer SSD und einer HDD als Backup-Ziel?', a: 'SSD: Extrem schnell, teurer (gut für RTO-kritische Daten). HDD: Günstiger bei großen Kapazitäten, langsamer (Standard für die meisten Backups).' },
    ...
    { id: '1.3.5_2', q: 'Wofür steht die Abkürzung GoBD?', a: 'Grundsätze zur ordnungsgemäßen Führung und Aufbewahrung von Büchern, Aufzeichnungen und Unterlagen in elektronischer Form sowie zum Datenzugriff.' },
    { id: '1.3.5_3', q: 'Was ist der Kernunterschied zwischen Backup und Archivierung im rechtlichen Sinne?', a: 'Backup dient der technischen Wiederherstellung nach Datenverlust. Archivierung dient der Erfüllung gesetzlicher Aufbewahrungspflichten und der Beweiskraft.' },
    { id: '1.3.5_4', q: 'Welche Rolle spielt die "Verfahrensdokumentation" bei der GoBD?', a: 'Sie beschreibt lückenlos den gesamten Prozess der Entstehung, Verarbeitung, Speicherung und Sicherung von steuerrelevanten Daten im Unternehmen.' },
    { id: '1.3.5_5', q: 'Wie lange müssen steuerrelevante Belege (z.B. Rechnungen) laut Gesetz archiviert werden?', a: 'In der Regel 10 Jahre (beginnend mit dem Ende des Kalenderjahres, in dem der Beleg erstellt wurde).' },
    ...
    { id: '1.3.5_7', q: 'Darf eine Archivierung in der Cloud erfolgen?', a: 'Ja, sofern der Provider entsprechende Zertifizierungen (z.B. IDW PS 880) vorweisen kann und die Daten gegen unbefugten Zugriff und Veränderung geschützt sind.' },
    ...
    { id: '1.3.5_9', q: 'Was ist ein DMS (Dokumentenmanagementsystem)?', a: 'Eine Software zur Verwaltung, Archivierung und Suche von elektronischen Dokumenten, die oft die Grundlage für revisionssichere Archivierung bildet.' },
    ...
    { id: '1.3.6_2', q: 'Welchen Zweck haben regelmäßige Disaster-Recovery-Tests (K-Fall-Übungen)?', a: 'Sicherstellen, dass die Notfallpläne aktuell sind, die Technik funktioniert und die Mitarbeiter wissen, was im Ernstfall zu tun ist (Validierung von RTO/RPO).' },
    ...
    { id: '1.3.6_5', q: 'Erkläre den Begriff "Cloud Disaster Recovery" (DRaaS).', a: 'Disaster Recovery as a Service. Die Wiederherstellung von IT-Services in einer Cloud-Umgebung, falls das eigene Rechenzentrum ausfällt.' },
    { id: '1.3.6_6', q: 'Warum ist räumliche Distanz zwischen Backup-Standort und Hauptstandort wichtig?', a: 'Um die Daten vor regionalen Katastrophen zu schützen, die beide Standorte gleichzeitig treffen könnten (z.B. Hochwasser, Erdbeben, großflächiger Stromausfall).' },
    ...
    { id: '1.3.6_8', q: 'Welche Aufgabe hat the "Business Impact Analysis" (BIA) im Notfallkonzept?', a: 'Sie bewertet die Auswirkungen von Ausfällen auf einzelne Geschäftsprozesse, um die Wiederherstellung sinnvoll zu priorisieren.' },
    { id: '1.3.6_9', q: 'Warum sind Ersatz-Switches und Ersatz-Router Teil eines guten Disaster Recovery Konzepts?', a: 'Damit am Ausweichstandort sofort die notwendige Netzwerk-Infrastruktur aufgebaut werden kann, um die Server wieder erreichbar zu machen.' },
    { id: '1.3.6_10', q: 'Was beschreibt der "Wiederanlaufplan"?', a: 'Der Teil des Notfallkonzepts, der genau festlegt, in welcher Reihenfolge und mit welchen Schritten die IT-Systeme nach einem Totalausfall wieder hochgefahren werden.' },
    ],

    // Topic 1.4: Automatisierung & Logik (Ziel: 70 Karten)
    '1.4': [
    // --- 1.4.1 Scripting: PowerShell, Bash, Python (10 Karten) ---
    { id: '1.4.1_1', q: 'Was ist der Hauptvorteil der PowerShell gegenüber der klassischen CMD?', a: 'PowerShell arbeitet objektorientiert statt textbasiert. Ergebnisse von Befehlen (Cmdlets) können direkt als Objekte an andere Befehle weitergereicht werden (Pipelining).' },
    { id: '1.4.1_2', q: 'Welche Dateiendung haben PowerShell-Skripte standardmäßig?', a: '.ps1' },
    { id: '1.4.1_3', q: 'Was bewirkt die Shebang-Zeile (z.B. #!/bin/bash) am Anfang eines Skripts?', a: 'Sie gibt dem Betriebssystem an, welcher Interpreter (z.B. Bash, Python) genutzt werden soll, um das Skript auszuführen.' },
    { id: '1.4.1_4', q: 'Erkläre den Unterschied zwischen einer Variable und einer Konstante.', a: 'Variable: Ihr Wert kann sich während der Laufzeit des Skripts ändern. Konstante: Ihr Wert wird einmal zugewiesen und kann danach nicht mehr verändert werden.' },
    ...
    { id: '1.4.1_6', q: 'Wofür nutzt ein Administrator "Cronjobs" (Linux) oder die "Aufgabenplanung" (Windows)?', a: 'Zur zeitgesteuerten, automatisierten Ausführung von Skripten oder Programmen (z.B. nächtliches Backup-Skript).' },
    ...
    { id: '1.4.1_8', q: 'Was beschreibt der Begriff "Fehlerbehandlung" (Error Handling) mittels Try-Catch?', a: 'Ein Mechanismus, um Laufzeitfehler während des Skript-Ablaufs abzufangen und darauf zu reagieren, statt das Skript unkontrolliert abstürzen zu lassen.' },
    ...
    { id: '1.4.2_1', q: 'Was ist der Hauptzweck von Regulären Ausdrücken (Regex)?', a: 'Das Suchen, Filtern und Validieren von Texten basierend auf komplexen Mustern.' },
    ...
    { id: '1.4.2_5', q: 'Was bewirkt das Sternchen (*) in Regex?', a: 'Das vorangegangene Zeichen (oder Gruppe) darf 0-mal oder beliebig oft vorkommen.' },
    ...
    { id: '1.4.2_8', q: 'Was bedeutet das Escape-Zeichen \ (Backslash) in Regex?', a: 'Es hebt die Sonderfunktion eines Metazeichens auf (z.B. \. sucht nach einem echten Punkt statt nach einem Platzhalter).' },
    ...
    { id: '1.4.3_1', q: 'Was ist der Unterschied zwischen "git commit" und "git push"?', a: 'Commit speichert die Änderungen lokal in der Versionshistorie deines Rechners. Push überträgt diese lokalen Commits an einen entfernten Server (Remote Repository).' },
    { id: '1.4.3_2', q: 'Was bewirkt der Befehl "git clone"?', a: 'Er erstellt eine vollständige lokale Kopie eines entfernten Repositorys inklusive der gesamten Historie aller Versionen.' },
    { id: '1.4.3_3', q: 'Wofür nutzt man "Branches" in Git?', a: 'Um parallel an verschiedenen Features oder Bugfixes zu arbeiten, ohne den stabilen Hauptzweig (Main/Master) zu gefährden.' },
    ...
    { id: '1.4.3_6', q: 'Was macht der Befehl "git pull"?', a: 'Er lädt die neuesten Änderungen vom Remote-Server herunter und führt sie sofort mit deinem aktuellen lokalen Branch zusammen (Fetch + Merge).' },
    { id: '1.4.3_7', q: 'Was beschreibt die "Staging Area" (Index)?', a: 'Ein Zwischenbereich, in dem Änderungen gesammelt werden (git add), bevor sie mit einem Commit final gespeichert werden.' },
    { id: '1.4.3_8', q: 'Was ist der Vorteil eines dezentralen Versionsverwaltungssystems (DVCS) wie Git?', a: 'Jeder Entwickler hat die komplette Historie lokal vorliegen. Man kann offline arbeiten und ist nicht von einem zentralen Server abhängig.' },
    ...
    { id: '1.4.4_2', q: 'Was ist der Zweck eines Struktogramms (Nassi-Shneiderman-Diagramm)?', a: 'Die grafische Darstellung der Logik eines Algorithmus ohne GOTO-Befehle, was eine strukturierte Programmierung erzwingt.' },
    { id: '1.4.4_3', q: 'Welches Symbol stellt eine "Entscheidung" (If-Else) im Aktivitätsdiagramm dar?', a: 'Eine Raute mit einem Eingang und zwei (oder mehr) Ausgängen, die mit Bedingungen (Guards) in eckigen Klammern beschriftet sind.' },
    ...
    { id: '1.4.4_5', q: 'Erkläre den Unterschied zwischen einer kopfgesteuerten und einer fußgesteuerten Schleife.', a: 'Kopfgesteuert: Prüfung der Bedingung VOR dem Durchlauf (kann 0-mal laufen). Fußgesteuert: Prüfung NACH dem Durchlauf (läuft mindestens 1-mal).' },
    { id: '1.4.4_6', q: 'Was ist "Pseudocode"?', a: 'Eine Mischung aus natürlicher Sprache und Programmiersyntax, die Logik verständlich darstellt, ohne an eine konkrete Sprache gebunden zu sein.' },
    ...
    { id: '1.4.4_10', q: 'Was ist die Aufgabe einer "Trace-Tabelle"?', a: 'Die Dokumentation der Variablenwerte nach jedem einzelnen Schritt eines Algorithmus während eines Schreibtischtests.' },
    ...
    { id: '1.4.5_3', q: 'Was ist eine m:n Beziehung und wie wird sie im relationalen Modell umgesetzt?', a: 'Viele Datensätze aus A können mit vielen aus B verknüpft sein. Umsetzung über eine Zwischentabelle, die die Primärschlüssel beider Tabellen als Fremdschlüssel enthält.' },
    { id: '1.4.5_4', q: 'Definition eines Primärschlüssels (PK)?', a: 'Ein Attribut oder eine Attributkombination, das jeden Datensatz einer Tabelle eindeutig identifiziert.' },
    ...
    { id: '1.4.5_10', q: 'Was bedeutet "Referenzielle Integrität"?', a: 'Jeder Fremdschlüsselwert muss entweder existieren (als PK in der Zieltabelle) oder NULL sein. Sichert die logische Konsistenz zwischen Tabellen.' },

    // --- 1.4.6 SQL: DQL & DML (10 Karten) ---
    { id: '1.4.6_1', q: 'Was bewirkt ein INNER JOIN?', a: 'Er gibt nur die Datensätze zurück, die in beiden verknüpften Tabellen eine Übereinstimmung haben.' },
    { id: '1.4.6_2', q: 'Was ist der Unterschied zwischen einem LEFT JOIN und einem RIGHT JOIN?', a: 'LEFT JOIN gibt alle Zeilen der linken Tabelle zurück, RIGHT JOIN alle der rechten. Fehlende Gegenstücke werden mit NULL aufgefüllt.' },
    ...
    { id: '1.4.6_4', q: 'Unterschied zwischen WHERE und HAVING?', a: 'WHERE filtert einzelne Zeilen VOR der Gruppierung. HAVING filtert die Gruppen NACH der Aggregation.' },
    { id: '1.4.6_5', q: 'Was bewirkt der SQL-Befehl UPDATE?', a: 'Er ändert bestehende Datensätze in einer Tabelle. Wichtig: Immer eine WHERE-Klausel nutzen, um nicht alle Zeilen zu ändern!' },
    { id: '1.4.6_6', q: 'Was macht der Befehl DELETE im Gegensatz zu TRUNCATE?', a: 'DELETE löscht einzelne Zeilen (langsam, logbar, Trigger feuern). TRUNCATE leert die gesamte Tabelle (schnell, kein Einzel-Logging).' },
    { id: '1.4.6_7', q: 'Was ist eine Subquery (Unterabfrage)?', a: 'Eine SELECT-Abfrage, die innerhalb einer anderen SQL-Abfrage eingebettet ist.' },
    ...
    { id: '1.4.6_9', q: 'Was bewirkt "ORDER BY" am Ende einer Abfrage?', a: 'Es sortiert die Ergebnismenge aufsteigend (ASC) oder absteigend (DESC) nach einer oder mehreren Spalten.' },
    { id: '1.4.6_10', q: 'Was ist ein "Index" in einer Datenbank?', a: 'Eine zusätzliche Datenstruktur, die Suchabfragen massiv beschleunigt, aber Schreibvorgänge etwas verlangsamt.' },
    ...
    { id: '1.4.7_5', q: 'Was ist eine "Transaktion" in einer Datenbank?', a: 'Eine logische Einheit von einer oder mehreren Datenbankoperationen, die als Ganzes erfolgreich sein müssen.' },
    { id: '1.4.7_6', q: 'Was bewirkt der Befehl COMMIT?', a: 'Er schließt eine Transaktion erfolgreich ab und schreibt die Änderungen dauerhaft in die Datenbank.' },
    ...
    { id: '1.4.7_8', q: 'Was beschreibt das Problem des "Dirty Read"?', a: 'Eine Transaktion liest Daten, die von einer anderen noch nicht abgeschlossenen Transaktion geändert wurden (verletzt Isolation).' },
    { id: '1.4.7_9', q: 'Was ist ein "Deadlock" im Kontext von Transaktionen?', a: 'Zwei Transaktionen blockieren sich gegenseitig, da jede auf eine Ressource wartet, die die andere gerade hält.' },
    ...
    { id: '2.1.1_1', q: 'Nenne die 7 Schichten des OSI-Modells in der richtigen Reihenfolge (von 1 bis 7).', a: '1. Physical, 2. Data Link, 3. Network, 4. Transport, 5. Session, 6. Presentation, 7. Application.' },
    ...
    { id: '2.1.1_4', q: 'Auf welcher OSI-Schicht arbeitet das IP-Protokoll und wie nennt man die Dateneinheit dort?', a: 'Schicht 3 (Network Layer). Die Dateneinheit heißt Paket.' },
    { id: '2.1.1_5', q: 'Nenne die 4 Schichten des TCP/IP-Referenzmodells.', a: '1. Netzzugriffsschicht (Network Access), 2. Internetschicht (Internet), 3. Transportschicht (Transport), 4. Anwendungsschicht (Application).' },
    ...
    { id: '2.1.1_7', q: 'Welche OSI-Schicht ist für die Ende-zu-Ende-Verbindung und Fehlerkontrolle verantwortlich?', a: 'Schicht 4 (Transport Layer).' },
    { id: '2.1.1_8', q: 'Wie nennt man die Dateneinheit auf Schicht 2 (OSI)?', a: 'Frame (Rahmen).' },
    { id: '2.1.1_9', q: 'Was ist der Hauptunterschied zwischen OSI und TCP/IP Modell?', a: 'OSI ist ein theoretisches, herstellerunabhängiges Referenzmodell mit 7 Schichten. TCP/IP ist ein praxisorientiertes Modell mit 4 Schichten, auf dem das Internet basiert.' },
    { id: '2.1.1_10', q: 'Auf welcher OSI-Schicht findet die Kompression und Verschlüsselung von Daten statt?', a: 'Schicht 6 (Presentation Layer).' },

    // --- 2.1.2 Layer 2: Ethernet, MAC, ARP, VLAN (10 Karten) ---
    { id: '2.1.2_1', q: 'Wie ist eine MAC-Adresse aufgebaut?', a: '48 Bit lang, hexadezimal geschrieben. Die ersten 24 Bit sind die OUI (Herstellerkennung), die letzten 24 Bit sind eine fortlaufende Nummer (NIC).' },
    { id: '2.1.2_2', q: 'Was ist die Aufgabe des ARP-Protokolls?', a: 'Address Resolution Protocol. Es löst bekannte IP-Adressen in die zugehörigen MAC-Adressen im lokalen Netzwerk auf.' },
    { id: '2.1.2_3', q: 'Erkläre den Begriff "VLAN Tagging" nach IEEE 802.1Q.', a: 'Ein Ethernet-Frame wird um eine 4-Byte-Kennung (Tag) erweitert, die die VLAN-ID enthält. So können mehrere logische Netze über ein physisches Kabel (Trunk) übertragen werden.' },
    { id: '2.1.2_4', q: 'Was ist der Unterschied zwischen einem "Access Port" und einem "Trunk Port"?', a: 'Access Port: Gehört zu genau einem VLAN (für Endgeräte). Trunk Port: Überträgt Daten mehrerer VLANs gleichzeitig (zwischen Switches).' },
    ...
    { id: '2.1.2_6', q: 'Was passiert, wenn ein Switch die Ziel-MAC eines Frames nicht in seiner MAC-Tabelle kennt?', a: 'Er führt ein "Flooding" durch: Der Frame wird an alle Ports (außer dem Eingangsport) weitergeleitet.' },
    { id: '2.1.2_7', q: 'Welchen Vorteil bietet "Full-Duplex" gegenüber "Half-Duplex"?', a: 'Gleichzeitiges Senden und Empfangen von Daten möglich. Kollisionen sind physikalisch ausgeschlossen, die Bandbreite verdoppelt sich effektiv.' },
    { id: '2.1.2_8', q: 'Was ist die "Maximum Transmission Unit" (MTU) im Standard-Ethernet?', a: '1500 Bytes (Nutzdaten eines Frames).' },
    ...
    { id: '2.1.2_10', q: 'Zweck eines "VLAN-Management" Netzwerks?', a: 'Ein separates VLAN (oft VLAN 1 standardmäßig), das nur für den administrativen Zugriff auf die Netzwerkgeräte (Switches, APs) genutzt wird.' },

    // --- 2.1.3 Spanning Tree: STP (10 Karten) ---
    { id: '2.1.3_1', q: 'Was ist die Hauptaufgabe des Spanning Tree Protocol (STP)?', a: 'Vermeidung von logischen Schleifen (Loops) in redundanten Ethernet-Netzwerken durch gezieltes Deaktivieren von Pfaden.' },
    { id: '2.1.3_2', q: 'Was passiert in einem Layer-2-Netz ohne STP bei redundanten Wegen?', a: 'Es entsteht ein Broadcast-Sturm: Broadcast-Frames kreisen endlos im Netz, vervielfältigen sich und legen die gesamte Kommunikation lahm.' },
    { id: '2.1.3_3', q: 'Welche Instanz wird im STP als erstes gewählt?', a: 'Die Root-Bridge (Zentraler Bezugspunkt für den Baum).' },
    { id: '2.1.3_4', q: 'Anhand welcher Kriterien wird die Root-Bridge gewählt?', a: 'Anhand der Bridge-ID (BID). Diese besteht aus der Priority (Standard 32768) und der MAC-Adresse. Die niedrigste BID gewinnt.' },
    { id: '2.1.3_5', q: 'Nenne die drei Port-Rollen in einem stabilen STP-Netz.', a: '1. Root Port (bester Weg zur Root-Bridge), 2. Designated Port (weiterleitender Port im Segment), 3. Blocking Port (deaktivierter Port zur Loop-Vermeidung).' },
    { id: '2.1.3_6', q: 'Wie erkennt STP den "besten" Pfad zur Root-Bridge?', a: 'Über die Pfadkosten (Path Cost). Diese richten sich nach der Bandbreite der Verbindung (höhere Bandbreite = niedrigere Kosten).' },
    { id: '2.1.3_7', q: 'Wofür steht die Abkürzung BPDU?', a: 'Bridge Protocol Data Unit. Das sind die Steuerpakete, die Switches untereinander austauschen, um die STP-Topologie zu berechnen.' },
    { id: '2.1.3_8', q: 'Was ist der Vorteil von Rapid Spanning Tree (RSTP, 802.1w)?', a: 'Viel schnellere Konvergenzzeit (Umschaltzeit bei Ausfällen) von wenigen Sekunden gegenüber bis zu 50 Sekunden beim klassischen STP.' },
    { id: '2.1.3_9', q: 'Was beschreibt "PortFast" (oder Edge Port) bei STP?', a: 'Ein Feature, das Ports für Endgeräte sofort in den Forwarding-Zustand versetzt, ohne die Listening/Learning-Phasen zu durchlaufen.' },
    ...
    { id: '2.1.4_8', q: 'Was bedeutet CIDR?', a: 'Classless Inter-Domain Routing. Die Ablösung der starren Netzklassen (A, B, C) durch die Präfix-Notation (z.B. /21).' },
    { id: '2.1.4_9', q: 'Welche Adresse ist die Loopback-Adresse in IPv4?', a: '127.0.0.1 (steht für den lokalen Host selbst).' },
    { id: '2.1.4_10', q: 'Wie lautet die Subnetzmaske für ein /27 Netz in Dezimalschreibweise?', a: '255.255.255.224.' },
    ...
    { id: '2.1.5_3', q: 'Was beschreibt the "Interface Identifier" bei einer IPv6-Adresse?', a: 'Die hinteren 64 Bit der Adresse, die die Host innerhalb des Subnetzes eindeutig identifizieren.' },
    ...
    { id: '2.1.5_6', q: 'Wofür steht die Abkürzung SLAAC?', a: 'Stateless Address Autoconfiguration. Ein Verfahren, bei dem sich Hosts ohne DHCPv6 selbst eine IP-Adresse generieren (basierend auf Router Advertisements).' },
    ...
    { id: '2.1.5_9', q: 'Welche Aufgabe übernimmt das ICMPv6-Protokoll?', a: 'Es ist deutlich mächtiger als ICMPv4 und übernimmt bei IPv6 auch Aufgaben wie Neighbor Discovery (Ersatz für ARP) und Fehlermeldungen.' },
    ...
    { id: '2.1.6_2', q: 'Was ist der Unterschied zwischen einer statischen und einer dynamischen Route?', a: 'Statisch: Vom Admin manuell eingetragen (unflexibel, aber sicher). Dynamisch: Von Routing-Protokollen (OSPF, BGP) automatisch berechnet und bei Topologie-Änderungen angepasst.' },
    { id: '2.1.6_3', q: 'Was beschreibt the "Metrik" in einer Routing-Tabelle?', a: 'Ein Wert für the "Kosten" eines Pfades. Haben zwei Routen dasselbe Ziel, wird die Route mit der niedrigeren Metrik bevorzugt.' },
    { id: '2.1.6_4', q: 'Was ist the "Administrative Distanz" (AD)?', a: 'Ein Maß für die Vertrauenswürdigkeit einer Routing-Quelle. Je niedriger die AD, desto vertrauenswürdiger (z.B. Direkt verbunden = 0, Statisch = 1, OSPF = 110).' },
    { id: '2.1.6_5', q: 'Welche Aufgabe hat das Standard-Gateway (Default Gateway)?', a: 'Es ist die Adresse, an die alle Pakete geschickt werden, für die der Router keinen spezifischen Eintrag in seiner Routing-Tabelle hat (Route 0.0.0.0/0).' },
    ...
    { id: '2.1.6_8', q: 'Was ist die Aufgabe von BGP (Border Gateway Protocol)?', a: 'Es ist das primäre Routing-Protokoll des Internets (Exterior Gateway Protocol) und verbindet verschiedene Autonome Systeme (AS).' },
    { id: '2.1.6_9', q: 'Was versteht man unter "Convergence" (Konvergenz) im Routing?', a: 'Der Zustand, in dem alle Router im Netzwerk dieselben Informationen über die Topologie haben und die Tabellen stabil sind.' },
    { id: '2.1.6_10', q: 'Was bewirkt der Befehl "tracert" (Windows) oder "traceroute" (Linux)?', a: 'Er macht den Weg eines Pakets über alle Zwischenstationen (Hops) zum Ziel sichtbar, indem er die TTL (Time to Live) schrittweise erhöht.' },

    // --- 2.1.7 Layer 4: TCP & UDP (10 Karten) ---
    { id: '2.1.7_1', q: 'Erkläre den "Three-Way-Handshake" beim Verbindungsaufbau von TCP.', a: '1. Client schickt SYN (Synchronize). 2. Server antwortet mit SYN-ACK (Synchronize-Acknowledge). 3. Client bestätigt mit ACK (Acknowledge). Erst dann ist die Verbindung aufgebaut.' },
    ...
    { id: '2.1.7_6', q: 'Zweck der "Sequenznummer" in einem TCP-Header?', a: 'Sie ermöglicht es dem Empfänger, die Datenpakete wieder in die richtige Reihenfolge zu bringen und fehlende Pakete zu erkennen.' },
    ...
    { id: '2.1.8_1', q: 'Beschreibe die 4 Phasen des DHCP-Lease-Vorgangs (DORA).', a: '1. Discover (Client sucht Server). 2. Offer (Server bietet IP an). 3. Request (Client fordert IP an). 4. Acknowledge (Server bestätigt Vergabe).' },
    { id: '2.1.8_2', q: 'Was ist der Unterschied zwischen einer iterativen und einer rekursiven DNS-Abfrage?', a: 'Rekursiv: Der DNS-Server übernimmt die komplette Suche für den Client. Iterativ: Der DNS-Server gibt nur Verweise auf andere zuständige Nameserver zurück.' },
    ...
    { id: '2.1.8_4', q: 'Unterschied zwischen HTTP und HTTPS?', a: 'HTTPS verschlüsselt die HTTP-Datenübertragung mittels TLS (Transport Layer Security) zur Sicherung von Vertraulichkeit und Integrität.' },
    ...
    { id: '2.1.8_6', q: 'Wofür wird das FTP-Protokoll genutzt und nenne die zwei Standard-Ports.', a: 'File Transfer Protocol zum Übertragen von Dateien. Port 21 (Steuerkanal), Port 20 (Datenkanal).' },
    { id: '2.1.8_7', q: 'Was ist der Unterschied zwischen IMAP und POP3 beim E-Mail-Abruf?', a: 'POP3 lädt Mails herunter und löscht sie meist vom Server. IMAP synchronisiert Mails zwischen Server und Client (Mails bleiben auf dem Server).' },
    { id: '2.1.8_8', q: 'Was beschreibt the "TTL" (Time to Live) in einem DNS-Eintrag?', a: 'Die Zeitspanne in Sekunden, die ein DNS-Eintrag im Cache eines Resolvers gespeichert werden darf, bevor er erneut abgefragt werden muss.' },
    ...
    { id: '2.1.8_10', q: 'Was ist der Unterschied zwischen Port 443 (HTTPS) und Port 80 (HTTP)?', a: 'Port 443 ist für verschlüsselten Webverkehr (TLS), Port 80 für unverschlüsselten Klartextverkehr.' },
    ...
    { id: '2.1.9_3', q: 'Was versteht man unter PAT (Port Address Translation / Masquerading)?', a: 'Die häufigste Form von NAT. Viele interne Hosts nutzen eine einzige öffentliche IP. Die Unterscheidung der Datenströme erfolgt über die Quell-Portnummern.' },
    ...
    { id: '2.1.9_7', q: 'Welche Rolle spielt the "Jitter" bei der Netzwerkqualität?', a: 'Jitter beschreibt die Schwankung der Latenzzeit (Delay). Hoher Jitter führt besonders bei Echtzeit-Anwendungen wie Telefonie zu Aussetzern oder Störungen.' },
    { id: '2.1.9_8', q: 'Was beschreibt "Latenz" (Latency) im Netzwerk?', a: 'Die Verzögerungszeit, die ein Datenpaket vom Sender bis zum Empfänger benötigt.' },
    ...
    { id: '2.1.9_10', q: 'Was bedeutet "Traffic Shaping"?', a: 'Eine Methode des Bandbreitenmanagements, bei der Datenströme verzögert oder begrenzt werden, um die Einhaltung einer bestimmten Datenrate zu erzwingen.' },
    ],

  // Topic 2.2: Netzwerk-Design & Hardware (Ziel: 60 Karten)
  '2.2': [
    // --- 2.2.1 Topologien (10 Karten) ---
    { id: '2.2.1_1', q: 'Was ist das Merkmal einer Stern-Topologie?', a: 'Alle Endgeräte sind mit einem zentralen Knoten (Switch/Hub) verbunden. Fällt ein Endgerät aus, hat dies keine Auswirkungen auf das restliche Netz. Fällt der zentrale Knoten aus, steht das Netz still.' },
    { id: '2.2.1_2', q: 'Erkläre den Unterschied zwischen einer vollvermaschten und einer teilvermaschten Topologie (Mesh).', a: 'Vollvermascht: Jedes Gerät ist mit jedem anderen Gerät direkt verbunden (höchste Redundanz, teuer). Teilvermascht: Nur wichtige Knoten haben mehrere Verbindungen untereinander.' },
    { id: '2.2.1_3', q: 'Was beschreibt die "Spine-Leaf" Architektur im Rechenzentrum?', a: 'Eine zweistufige Topologie: Leaf-Switches (unten) verbinden Server, Spine-Switches (oben) verbinden alle Leaf-Switches untereinander. Sichert konstante Latenz und hohe Bandbreite (East-West Traffic).' },
    { id: '2.2.1_4', q: 'Was ist eine Baum-Topologie?', a: 'Eine hierarchische Struktur, die aus mehreren Stern-Topologien besteht, die über eine Wurzel (Root) miteinander verbunden sind (oft in Firmengebäuden über Etagen-Switches).' },
    { id: '2.2.1_5', q: 'Was ist der Unterschied zwischen einer physischen und einer logischen Topologie?', a: 'Physisch: Die tatsächliche Verkabelung der Geräte. Logisch: Der Weg, den die Datenpakete im Netzwerk nehmen (kann durch VLANs oder STP abweichen).' },
    { id: '2.2.1_6', q: 'Welche Aufgabe hat der "Terminator" in einer Bus-Topologie?', a: 'Er verhindert Signalreflexionen an den Kabelenden, die sonst die Kommunikation auf dem Bus stören würden.' },
    { id: '2.2.1_7', q: 'Nenne einen Vorteil und einen Nachteil der Ring-Topologie.', a: 'Vorteil: Einfache Verkabelung, deterministischer Zugriff. Nachteil: Fällt ein Knoten oder das Kabel aus, ist die gesamte Kommunikation im Ring unterbrochen (ohne Spezialmechanismen).' },
    { id: '2.2.1_8', q: 'Warum ist die Stern-Topologie der Standard in lokalen Netzen (LANs)?', a: 'Leicht erweiterbar, einfache Fehlersuche, hohe Ausfallsicherheit für einzelne Teilnehmer und zentrale Verwaltung über Switches.' },
    { id: '2.2.1_9', q: 'Was beschreibt der Begriff "Redundanz" in einer Netzwerktopologie?', a: 'Das Vorhandensein von zusätzlichen Wegen oder Geräten, um beim Ausfall einer Komponente den Weiterbetrieb des Netzwerks sicherzustellen.' },
    ...
    { id: '2.2.2_1', q: 'Was bedeutet die Bezeichnung "S/FTP" bei einem Netzwerkkabel?', a: 'Screened Foiled Twisted Pair. Das Kabel hat einen Gesamtschirm (Geflecht) und die einzelnen Adernpaare sind zusätzlich mit Folie geschirmt (sehr guter Schutz gegen EMV).' },
    ...
    { id: '2.2.2_3', q: 'Was ist der Unterschied zwischen Single-Mode (SM) und Multi-Mode (MM) Glasfaserkabeln?', a: 'Single-Mode: Sehr dünner Kern (9µm), nur ein Lichtstrahl (Laser), für sehr lange Strecken (km). Multi-Mode: Dickerer Kern (50/62µm), mehrere Lichtstrahlen (LED/VCSEL), für kurze Strecken (Rechenzentrum).' },
    { id: '2.2.2_4', q: 'Was versteht man unter PoE (Power over Ethernet) und wozu dient es?', a: 'Stromversorgung von Netzwerkgeräten (z.B. IP-Telefone, Kameras, APs) direkt über das Datenkabel (Twisted Pair).' },
    { id: '2.2.2_5', q: 'Was ist ein SFP+ Modul?', a: 'Small Form-factor Pluggable. Ein kompakter, Hot-Swap-fähiger Transceiver, der in einen Switch-Port gesteckt wird, den Verbindungstyp (z.B. Glasfaser oder Kupfer) festzulegen.' },
    { id: '2.2.2_6', q: 'Was beschreibt die "Dämpfung" bei einem Übertragungsmedium?', a: 'Der Verlust an Signalstärke über die Länge des Kabels. Sie begrenzt die maximale Reichweite (z.B. max. 100m bei Kupfer-Ethernet).' },
    ...
    { id: '2.2.2_8', q: 'Was ist der Unterschied zwischen einem Patchkabel und einem Verlegekabel?', a: 'Verlegekabel: Starre Adern (Massivdraht), für feste Installation in Wänden. Patchkabel: Flexible Litzen, für die Verbindung zwischen Geräten.' },
    ...
    { id: '2.2.3_1', q: 'Was ist der Hauptunterschied zwischen einem Layer-2 und einem Layer-3 Switch?', a: 'L2-Switch: Arbeitet auf Schicht 2 (MAC-Adressen) innerhalb eines Subnetzes. L3-Switch: Kann zusätzlich auf Schicht 3 (IP-Adressen) routen und somit verschiedene VLANs/Subnetze verbinden.' },
    ...
    { id: '2.2.3_3', q: 'Was versteht man unter "Stacking" bei Switches?', a: 'Das physische und logische Verbinden mehrerer Switches zu einer Einheit, die wie ein einziger Switch verwaltet wird. Erhöht Portdichte und Redundanz.' },
    { id: '2.2.3_4', q: 'Was beschreibt der Begriff "Throughput" (Durchsatz) eines Netzwerkgeräts?', a: 'Die tatsächlich übertragene Datenmenge pro Zeiteinheit (Nutzdaten), im Gegensatz zur theoretischen Bandbreite.' },
    { id: '2.2.3_5', q: 'Welchen Zweck hat ein "Modem" bei einer Internetanbindung?', a: 'Modulator-Demodulator. Es wandelt digitale Signale des Routers in die für das Übertragungsmedium (z.B. Telefonleitung, Kabelfernsehen) passenden Signale um.' },
    ...
    { id: '2.2.3_7', q: 'Was bewirkt die Funktion "Auto-MDI-X" an einem Switch-Port?', a: 'Der Port erkennt automatisch, ob ein Patchkabel oder ein Crossover-Kabel angeschlossen ist und passt die Sende-/Empfangsleitungen entsprechend an.' },
    ...
    { id: '2.2.3_9', q: 'Was beschreibt the "Backplane-Kapazität" eines Switches?', a: 'Die maximale Datenmenge, die die interne Elektronik des Switches gleichzeitig zwischen allen Ports verarbeiten kann (wichtig für die Performance).' },
    ...
    { id: '2.2.4_2', q: 'Nenne die theoretische Brutto-Datenrate von Wi-Fi 6.', a: 'Bis zu 9,6 Gbit/s (bei optimalen Bedingungen und vielen Streams).' },
    { id: '2.2.4_3', q: 'Was ist die entscheidende Verbesserung von WPA3 gegenüber WPA2?', a: 'Einführung von SAE (Simultaneous Authentication of Equals) gegen Offline-Wörterbuchattacken und stärkere Verschlüsselung (GCMP-256).' },
    { id: '2.2.4_4', q: 'Erkläre den Unterschied zwischen WPA-Personal (PSK) und WPA-Enterprise.', a: 'Personal: Ein gemeinsames Passwort für alle (Pre-Shared Key). Enterprise: Jeder Nutzer authentifiziert sich individuell (z.B. über einen RADIUS-Server).' },
    { id: '2.2.4_5', q: 'Was beschreibt the "Roaming" im WLAN?', a: 'Der nahtlose Wechsel eines Clients zwischen verschiedenen Access Points innerhalb desselben Netzwerks, ohne dass die Verbindung abbricht.' },
    ...
    { id: '2.2.4_7', q: 'Was versteht man unter "Beamforming" bei modernen WLAN-Routern?', a: 'Die gezielte Ausrichtung der Funksignale in die Richtung des Clients (statt kreisförmig in alle Richtungen), um Reichweite und Datenrate zu verbessern.' },
    ...
    { id: '2.2.5_1', q: 'Was ist der Hauptzweck eines VPN (Virtual Private Network)?', a: 'Die Herstellung einer gesicherten, verschlüsselten Verbindung über ein unsicheres Netzwerk (z.B. das Internet), um Daten vertraulich zu übertragen.' },
    { id: '2.2.5_2', q: 'Erkläre den Unterschied zwischen einem Site-to-Site VPN und einem Remote Access VPN.', a: 'Site-to-Site: Verbindet zwei komplette Netzwerke dauerhaft miteinander (z.B. Zentrale und Filiale). Remote Access: Ein einzelner Client verbindet sich temporär mit dem Firmennetz (z.B. Homeoffice).' },
    { id: '2.2.5_3', q: 'Welche zwei Phasen werden beim Aufbau eines IPsec-Tunnels durchlaufen?', a: 'Phase 1: Authentifizierung der Partner und Aushandeln der Verschlüsselungsparameter für den Management-Kanal (IKE). Phase 2: Aushandeln der Parameter für die eigentliche Datenübertragung (IPsec-SA).' },
    { id: '2.2.5_4', q: 'Was ist der Vorteil von SSL/TLS-VPN gegenüber IPsec-VPN für Homeoffice-Nutzer?', a: 'SSL-VPN benötigt oft keine spezielle Client-Software (läuft über den Browser) und ist einfacher durch Firewalls zu führen, da es Standard-HTTPS-Ports nutzt.' },
    ...
    { id: '2.2.5_6', q: 'Welche Aufgabe hat das Protokoll "ESP" (Encapsulating Security Payload) in IPsec?', a: 'Es sorgt für die Verschlüsselung, Authentizität und Integrität der eigentlichen Nutzdaten im Tunnel.' },
    ...
    { id: '2.2.5_8', q: 'Was ist der Vorteil von SD-WAN gegenüber klassischem MPLS?', a: 'Höhere Flexibilität, geringere Kosten durch Nutzung normaler Internetanschlüsse und zentrale, softwaregesteuerte Verwaltung des gesamten WAN-Verkehrs.' },
    { id: '2.2.5_9', q: 'Zweck eines "VPN-Gateways"?', a: 'Die zentrale Komponente (oft die Firewall oder ein dedizierter Server), die die VPN-Verbindungen terminiert, entschlüsselt und ins interne Netz weiterleitet.' },
    { id: '2.2.5_10', q: 'Warum ist MFA (Multi-Faktor-Authentifizierung) für VPN-Zugänge heute Standard?', a: 'Um den Zugriff auf das Firmennetzwerk auch dann zu schützen, wenn die Benutzerpasswörter (z.B. durch Phishing) gestohlen wurden.' },

    // --- 2.2.6 Internet-Anbindungen: FTTH, MPLS, SD-WAN (10 Karten) ---
    { id: '2.2.6_1', q: 'Was bedeutet die Abkürzung FTTH?', a: 'Fiber to the Home. Das Glasfaserkabel wird bis direkt in die Wohnung oder das Bürogebäude des Kunden verlegt.' },
    { id: '2.2.6_2', q: 'Erkläre den Unterschied zwischen GPON und AON bei Glasfaser-Anbindungen.', a: 'AON (Active Optical Network): Jeder Kunde hat eine eigene, dedizierte Faser zum Point of Presence. GPON (Passive Optical Network): Mehrere Kunden teilen sich eine Faser über passive Splitter (Shared Medium).' },
    { id: '2.2.6_3', q: 'Was ist das Hauptmerkmal von MPLS (Multiprotocol Label Switching)?', a: 'Datenpakete werden nicht anhand der IP-Zieladresse geroutet, sondern erhalten kurze Labels. Dies ermöglicht extrem schnelles Switching und die einfache Erstellung privater Firmennetze über Provider-Infrastrukturen.' },
    { id: '2.2.6_4', q: 'Welchen Vorteil bietet eine symmetrische Internetanbindung (z.B. 100/100 Mbit/s) für Firmen?', a: 'Die Upload-Geschwindigkeit ist genauso hoch wie die Download-Geschwindigkeit. Wichtig für der Betrieb von eigenen Servern, VPN-Einwahl oder Cloud-Backups.' },
    { id: '2.2.6_5', q: 'Was beschreibt der Begriff "Last Mile" (Die letzte Meile)?', a: 'Der physische Leitungsabschnitt zwischen der Vermittlungsstelle des Providers und dem Hausanschluss des Kunden.' },
    { id: '2.2.6_6', q: 'Was ist die Aufgabe eines "ONT" (Optical Network Terminal) bei einem Glasfaseranschluss?', a: 'Es wandelt die optischen Signale der Glasfaser in elektrische Signale für das lokale Ethernet-Netzwerk (Router) um.' },
    { id: '2.2.6_7', q: 'Wofür wird die "G.fast" Technologie genutzt?', a: 'Um über kurze Strecken bestehender Kupferdoppeladern (Telefonkabel) sehr hohe Datenraten (bis 1 Gbit/s) zu erzielen (oft bei FTTB genutzt).' },
    ...
    { id: '2.3.1_1', q: 'Was ist das Kernmerkmal einer "Stateful Inspection" Firewall?', a: 'Sie prüft nicht nur einzelne Pakete, sondern überwacht den Zustand (State) der gesamten Verbindung. Pakete werden nur durchgelassen, wenn sie zu einer bereits etablierten oder angeforderten Sitzung gehören.' },
    ...
    { id: '2.3.1_6', q: 'Zweck eines "Application Gateways" (Proxy-Firewall)?', a: 'Es trennt die Verbindung zwischen Sender und Empfänger komplett auf und baut zwei separate Verbindungen auf. Dadurch findet eine vollständige Inhaltsprüfung auf Anwendungsebene statt.' },
    { id: '2.3.1_7', q: 'Was beschreibt der Begriff "Egress Filtering" bei einer Firewall?', a: 'Das Filtern des ausgehenden Verkehrs vom internen Netzwerk ins Internet, um z.B. die Kommunikation von Schadsoftware mit Command-and-Control-Servern zu verhindern.' },
    { id: '2.3.1_8', q: 'Welche Rolle spielt "SSL-Inspection" (HTTPS-Scanning) bei Firewalls?', a: 'Die Firewall bricht die verschlüsselte Verbindung auf (Man-in-the-Middle), um den Inhalt zu scannen, und verschlüsselt ihn danach neu. Erfordert die Installation eines Firewall-Zertifikats auf den Clients.' },
    { id: '2.3.1_9', q: 'Was ist eine "Stufenlose" (Transparent) Firewall?', a: 'Eine Firewall, die auf Schicht 2 (Bridge-Modus) arbeitet und keine eigene IP-Adresse im Netzwerk benötigt. Sie ist für Angreifer dadurch schwerer zu entdecken.' },
    ...
    { id: '2.3.2_1', q: 'Erkläre den Unterschied zwischen DoS und DDoS.', a: 'DoS (Denial of Service): Angriff von einem einzelnen System. DDoS (Distributed DoS): Gleichzeitiger, koordinierter Angriff von vielen Systemen (Botnet), um ein Ziel zu überlasten.' },
    { id: '2.3.2_2', q: 'Was ist "IP-Spoofing"?', a: 'Das Fälschen der Absender-IP-Adresse in einem Paket, um die Identität eines vertrauenswürdigen Hosts vorzutäuschen oder Antworten an ein Opfer umzuleiten (Reflektions-Angriff).' },
    { id: '2.3.2_3', q: 'Beschreibe den Ablauf eines "Man-in-the-Middle" (MITM) Angriffs.', a: 'Ein Angreifer schaltet sich unbemerkt in die Kommunikation zwischen zwei Partnern ein, liest Daten mit oder manipuliert diese, während beide glauben, direkt miteinander zu kommunizieren.' },
    { id: '2.3.2_4', q: 'Was versteht man unter "ARP-Poisoning"?', a: 'Das Senden falscher ARP-Antworten ins LAN, um die MAC-Adresse des Angreifers mit der IP des Gateways zu verknüpfen. Basis für lokale MITM-Angriffe.' },
    ...
    { id: '2.3.2_6', q: 'Erkläre den Begriff "Ransomware".', a: 'Schadsoftware, die die Daten auf einem System verschlüsselt und für die Entschlüsselung (die oft nie erfolgt) ein Lösegeld fordert.' },
    ...
    { id: '2.3.2_8', q: 'Was beschreibt der "DNS Rebinding" Angriff?', a: 'Ein bösartiges Skript im Browser des Opfers nutzt DNS-Änderungen, die Same-Origin-Policy zu umgehen und auf Geräte im internen Netzwerk zuzugreifen.' },
    ...
    { id: '2.3.3_1', q: 'Was ist der Unterschied zwischen IDS und IPS?', a: 'IDS (Intrusion Detection System): Erkennt Angriffe und meldet sie (passiv). IPS (Intrusion Prevention System): Erkennt Angriffe und ergreift sofort aktive Gegenmaßnahmen (aktiv), z.B. Blockieren der Absender-IP.' },
    ...
    { id: '2.3.3_3', q: 'Erkläre den Begriff "Honeypot" im Sicherheitskontext.', a: 'Ein bewusst verwundbares System (Köder), das Angreifer anlocken soll, um deren Methoden zu studieren und vom echten Netzwerk abzulenken.' },
    { id: '2.3.3_4', q: 'Was ist eine "einstufige DMZ" im Vergleich zu einer "zweistufigen DMZ"?', a: 'Einstufig: Eine Firewall mit drei Interfaces (WAN, LAN, DMZ). Zweistufig: Zwei Firewalls hintereinander (meist verschiedene Hersteller), zwischen denen die DMZ liegt (höhere Sicherheit).' },
    ...
    { id: '2.3.3_6', q: 'Was beschreibt "Port Security" an einem Switch?', a: 'Ein Sicherheitsmerkmal, das die Anzahl oder die konkreten MAC-Adressen der Geräte begrenzt, die an einem Port angeschlossen werden dürfen.' },
    { id: '2.3.3_7', q: 'Was ist die Aufgabe eines "RADIUS-Servers" bei der Netzwerksicherheit?', a: 'Zentrale Authentifizierung von Benutzern und Geräten (z.B. für WLAN nach 802.1X), um den Zugriff auf das Netzwerk zu kontrollieren.' },
    ...
    { id: '2.3.4_1', q: 'Erkläre den Unterschied zwischen "Polling" und "Traps" bei SNMP.', a: 'Polling: Das Monitoring-System fragt die Geräte aktiv ab. Trap: Das Gerät sendet bei einem Ereignis (z.B. Port-Ausfall) sofort von sich aus eine Meldung an das Monitoring-System.' },
    { id: '2.3.4_2', q: 'Was ist eine "MIB" (Management Information Base) im SNMP-Kontext?', a: 'Eine hierarchische Datenbankstruktur, die definiert, welche Informationen ein Gerät über SNMP bereitstellen kann (ähnlich einem Inhaltsverzeichnis).' },
    ...
    { id: '2.3.4_6', q: 'Was beschreibt the "Uptime" eines Systems?', a: 'Die Zeitspanne seit dem letzten Neustart des Systems. Ein Indikator für Stabilität, aber auch für fehlende Patches (wenn die Uptime zu hoch ist).' },
    ...
    { id: '2.3.4_9', q: 'Warum ist Monitoring für SLAs wichtig?', a: 'Es liefert die Beweise für die Einhaltung der vereinbarten Verfügbarkeiten und Reaktionszeiten.' },
    ...
    { id: '2.3.5_1', q: 'Was ist die Hauptaufgabe von Wireshark?', a: 'Ein Protokoll-Analysator (Sniffer), der den Netzwerkverkehr mitschneidet, decodiert und die einzelnen Schichten der Pakete grafisch darstellt.' },
    { id: '2.3.5_2', q: 'Wofür nutzt ein Administrator das Tool "Nmap"?', a: 'Zum Scannen von Netzwerken auf aktive Hosts, offene Ports und die Identifizierung von Betriebssystemen und Diensten (Security-Audit).' },
    { id: '2.3.5_3', q: 'Welche Informationen liefert der Befehl "dig" (oder nslookup)?', a: 'Informationen über DNS-Abfragen, wie IP-Adressen zu Hostnamen, MX-Records oder die zuständigen Nameserver für eine Domain.' },
    ...
    { id: '2.3.5_5', q: 'Was beschreibt the "Promiscuous Mode" einer Netzwerkkarte?', a: 'Ein Modus, in dem die Karte alle Frames im Netzwerksegment annimmt, auch wenn diese nicht an ihre eigene MAC-Adresse adressiert sind (nötig für Wireshark).' },
    { id: '2.3.5_6', q: 'Welchen Vorteil bietet "pathping" gegenüber "ping" und "tracert"?', a: 'Es kombiniert beide Funktionen und misst über einen längeren Zeitraum die Paketverluste an jedem einzelnen Hop, was Engpässe genauer lokalisiert.' },
    ...
    { id: '2.3.6_1', q: 'Warum ist eine aktuelle Netzwerkdokumentation für FISIs überlebenswichtig?', a: 'Sie ist die Basis für die Fehlersuche, Planung von Erweiterungen, Einhaltung von Compliance-Vorgaben und die Disaster Recovery.' },
    { id: '2.3.6_2', q: 'Was ist der Unterschied zwischen einem physischen und einem logischen Netzplan?', a: 'Physisch: Zeigt die tatsächliche Verkabelung, Ports, Patchpanel und Gerätestandorte. Logisch: Zeigt IP-Adressen, VLANs, Subnetze und Routing-Beziehungen.' },
    { id: '2.3.6_3', q: 'Wofür steht die Abkürzung IPAM?', a: 'IP Address Management. Die zentrale Verwaltung und Planung des IP-Adressraums im Unternehmen (Ersatz für Excel-Listen).' },
    ...
    { id: '2.3.6_6', q: 'Zweck eines "Betriebshandbuchs"?', a: 'Dokumentation aller täglichen Routineaufgaben, Standardabläufe und spezifischen System-Konfigurationen für die Administratoren.' },
    ...
    { id: '2.3.6_8', q: 'Was versteht man unter "VLAN-Dokumentation"?', a: 'Eine Liste aller genutzten VLAN-IDs, deren Namen (Zweck) und die zugewiesenen IP-Subnetze.' },
    { id: '2.3.6_9', q: 'Welche Rolle spielen "Etikettierungen" bei der Dokumentation?', a: 'Physische Kennzeichnung von Kabeln, Switch-Ports und Dosen, die exakt mit den Bezeichnungen im digitalen Netzplan übereinstimmen müssen.' },
    { id: '2.3.6_10', q: 'Was beschreibt der Begriff "Topology Discovery"?', a: 'Das automatisierte Erkennen und Zeichnen der Netzwerktopologie durch spezielle Software (z.B. mittels LLDP oder SNMP).' },
    ],
  ...
  '3.1': [
    ...
    { id: '3.1.1_1', q: 'Was ist das Hauptmerkmal des Wasserfallmodells?', a: 'Linearer, sequenzieller Ablauf in festen Phasen. Eine Phase muss beendet sein, bevor die nächste beginnt (Dokumentationsfokus).' },
    { id: '3.1.1_2', q: 'Wofür stehen die beiden Schenkel des V-Modells?', a: 'Links: Spezifikation (Anforderungen/Entwurf). Rechts: Verifikation (Teststufen). Mitte: Realisierung.' },
    { id: '3.1.1_3', q: 'Nenne die drei Rollen in einem Scrum-Team.', a: '1. Product Owner (PO), 2. Scrum Master (SM), 3. Developer (Entwicklungsteam).' },
    ...
    { id: '3.1.1_5', q: 'Was beschreibt the "Definition of Done" (DoD)?', a: 'Eine Checkliste von Qualitätskriterien, die ein Inkrement erfüllen muss, um als fertig und auslieferbar zu gelten.' },
    ...
    { id: '3.1.1_7', q: 'Welche Aufgabe hat der "Scrum Master"?', a: 'Er ist der "Servant Leader". Er sorgt für die Einhaltung der Scrum-Regeln, beseitigt Hindernisse und schützt das Team vor Störungen von außen.' },
    ...
    { id: '3.1.2_1', q: 'Was bedeutet die Abkürzung FAZ im Netzplan?', a: 'Frühestmöglicher Anfangszeitpunkt eines Vorgangs.' },
    ...
    { id: '3.1.2_6', q: 'Was ist der Unterschied zwischen dem Freien Puffer (FP) und dem Gesamtpuffer (GP)?', a: 'GP beeinflusst das Projektende. FP ist die Zeit, die ein Vorgang verschoben werden kann, ohne den FAZ des direkten Nachfolgers zu beeinflussen.' },
    { id: '3.1.2_7', q: 'Wie findet man die Root-Bridge (Anfang) im Netzplan beim Vorwärtsrechnen?', a: 'Man startet beim ersten Vorgang mit FAZ = 0.' },
    ...
    { id: '3.1.3_1', q: 'Definition des Gesamtpuffers (GP)?', a: 'Die Zeitspanne, die ein Vorgang gegenüber seinem frühestmöglichen Anfang verschoben werden kann, ohne das Projektende zu gefährden.' },
    { id: '3.1.3_2', q: 'Definition des Freien Puffers (FP)?', a: 'Die Zeitspanne, die ein Vorgang verschoben werden kann, ohne den frühestmöglichen Anfang (FAZ) des direkten Nachfolgers zu beeinflussen.' },
    ...
    { id: '3.1.3_6', q: 'Warum ist die Unterscheidung zwischen GP und FP für Projektleiter wichtig?', a: 'Sie zeigt die Flexibilität im Zeitplan. GP zeigt die Sicherheit zum Projektende, FP die Unabhängigkeit gegenüber dem nächsten Arbeitsschritt.' },
    ...
    { id: '3.1.4_1', q: 'Was ist der Hauptzweck eines Projektstrukturplans (PSP)?', a: 'Die vollständige, hierarchische Darstellung aller wesentlichen Elemente (Aufgaben) eines Projekts zur Schaffung von Transparenz und Struktur.' },
    { id: '3.1.4_2', q: 'Nenne die drei gängigen Gliederungsprinzipien eines PSP.', a: '1. Funktionsorientiert (Tätigkeiten), 2. Objektorientiert (Bauteile/Komponenten), 3. Phasenorientiert (Projektablauf).' },
    { id: '3.1.4_3', q: 'Was beschreibt der Begriff "Arbeitspaket" im PSP?', a: 'Die kleinste, nicht weiter zu unterteilende Einheit im PSP, die in sich abgeschlossen ist und einem Verantwortlichen zugeordnet werden kann.' },
    { id: '3.1.4_4', q: 'Was ist der Unterschied zwischen einem PSP und einem Netzplan?', a: 'PSP zeigt "Was" alles getan werden muss (hierarchisch). Netzplan zeigt "Wann" und in welcher logischen Reihenfolge es getan wird (zeitlich).' },
    ...
    { id: '3.1.4_7', q: 'Warum sollte ein PSP vollständig sein (100%-Regel)?', a: 'Damit keine Aufgaben vergessen werden und die Aufwands-, Kosten- und Zeitplanung auf einer soliden Basis steht.' },
    ...
    { id: '3.1.5_1', q: 'Welche Rolle spielt the "Zielgruppenanalyse" vor einer Präsentation?', a: 'Sie bestimmt die Tiefe und Sprache des Inhalts (z.B. technisches Detail für Admins vs. Nutzenfokus für Geschäftsführer).' },
    { id: '3.1.5_2', q: 'Nenne the "7-mal-7-Regel" für Präsentationsfolien.', a: 'Maximal 7 Zeilen pro Folie und maximal 7 Wörter pro Zeile, um die Lesbarkeit und Fokussierung zu gewährleisten.' },
    { id: '3.1.5_3', q: 'Was ist der Vorteil von Visualisierungen (Bilder, Diagramme) gegenüber reinem Text?', a: 'Informationen werden schneller aufgenommen, bleiben länger im Gedächtnis und lockern die Präsentation auf (Bildüberlegenheitseffekt).' },
    ...
    { id: '3.1.5_5', q: 'Welchen Zweck hat ein "Handout" bei einer Präsentation?', a: 'Es dient den Zuhörern als Gedächtnisstütze für die Zeit nach der Präsentation und enthält oft weiterführende Details oder Quellen.' },
    { id: '3.1.5_6', q: 'Was beschreibt the "Medienmix" in einer Präsentation?', a: 'Der abwechslungsreiche Einsatz verschiedener Medien (z.B. Beamer, Flipchart, Whiteboard, Live-Demo), um die Aufmerksamkeit hochzuhalten.' },
    { id: '3.1.5_7', q: 'Wie sollte die Körpersprache während einer Präsentation idealerweise sein?', a: 'Offene Haltung, Blickkontakt zum Publikum, angemessene Gestik zur Unterstützung des Gesagten und fester Stand.' },
    ...
    { id: '3.1.6_3', q: 'Was gehört in ein professionelles "Angebot"?', a: 'Leistungsbeschreibung, Preise, Liefertermine, Zahlungsbedingungen und Bezugnahme auf die AGB.' },
    { id: '3.1.6_4', q: 'Wie geht man professionell mit Einwänden des Kunden um (Einwandbehandlung)?', a: 'Zuhören, Verständnis zeigen, der wahren Grund hinter dem Einwand finden und Nutzenargumente liefern (z.B. Referenz-Methode, Bumerang-Methode).' },
    { id: '3.1.6_5', q: 'Was beschreibt der Begriff "After-Sales-Service"?', a: 'Die Betreuung des Kunden nach dem Kauf (z.B. Support, Schulungen, Wartung), um die Kundenzufriedenheit und langfristige Bindung zu sichern.' },
    { id: '3.1.6_6', q: 'Warum ist die Protokollierung von Kundengesprächen wichtig?', a: 'Zur Dokumentation getroffener Vereinbarungen, zur Vorbereitung von Folgeterminen und als rechtliche Absicherung.' },
    { id: '3.1.6_7', q: 'Was versteht man unter "Up-Selling" im Beratungskontext?', a: 'Dem Kunden eine höherwertige, teurere Version eines Produkts anbieten, die seinen Bedarf noch besser deckt.' },
    ...
    { id: '3.1.6_9', q: 'Zweck einer "Einweisung" des Kunden in ein neues System?', a: 'Sicherstellen, dass der Kunde die Lösung effektiv nutzen kann, Fehlbedienungen vermeiden und die Akzeptanz der neuen Lösung erhöhen.' },
  ...
  '3.2': [
    ...
    { id: '3.2.1_3', q: 'Wofür steht die Abkürzung KVP?', a: 'Kontinuierlicher Verbesserungsprozess. Das ständige Bestreben, Prozesse in kleinen Schritten immer weiter zu optimieren.' },
    { id: '3.2.1_4', q: 'Was beschreibt die Norm ISO 9001?', a: 'Den weltweit anerkannten Standard für Anforderungen an ein Qualitätsmanagementsystem (QMS) in Unternehmen.' },
    { id: '3.2.1_5', q: 'Was ist der Unterschied zwischen Qualitätssicherung (QS) und Qualitätsmanagement (QM)?', a: 'QM ist das übergeordnete System/Strategie. QS umfasst die konkreten operativen Maßnahmen (z.B. Tests), um die Qualitätsanforderungen zu erfüllen.' },
    ...
    { id: '3.2.1_7', q: 'Welche Rolle spielt die Dokumentation im Qualitätsmanagement?', a: 'Sie sichert die Nachvollziehbarkeit von Prozessen, dient als Wissensbasis und ist Voraussetzung für Zertifizierungen.' },
    { id: '3.2.1_8', q: 'Was beschreibt der Begriff "Null-Fehler-Strategie"?', a: 'Ein Ziel des QM, bei dem durch Fehlerprävention bereits bei der Entstehung von Leistungen jegliche Fehler vermieden werden sollen.' },
    { id: '3.2.1_9', q: 'Warum ist Kundenfeedback für den PDCA-Zyklus essenziell?', a: 'Es liefert die notwendigen Daten für die "Check"-Phase, um Abweichungen zwischen Soll-Qualität und Ist-Qualität zu erkennen.' },
    { id: '3.2.1_10', q: 'Was ist ein "Qualitätszirkel"?', a: 'Eine moderierte Gruppe von Mitarbeitern, die sich regelmäßig trifft, um Probleme im eigenen Arbeitsbereich zu analysieren und Lösungsvorschläge zu erarbeiten.' },
    ...
    { id: '3.2.2_3', q: 'Was wird beim Systemtest geprüft?', a: 'Das komplette System gegen die ursprünglichen funktionalen und nicht-funktionalen Anforderungen in einer produktionsnahen Umgebung.' },
    { id: '3.2.2_4', q: 'Was ist der Abnahmetest (User Acceptance Test - UAT)?', a: 'Der abschließende Test durch den Kunden oder Endnutzer, um zu entscheiden, ob die Software/Infrastruktur vertraglich erfüllt ist.' },
    { id: '3.2.2_5', q: 'Erkläre den Begriff "Regressionstest".', a: 'Wiederholung von bereits erfolgreichen Tests nach Änderungen am System, um sicherzustellen, dass keine neuen Fehler in bestehenden Funktionen eingebaut wurden.' },
    ...
    { id: '3.2.2_8', q: 'Welche Aufgabe haben "Stubs" und "Mocks" beim Testen?', a: 'Platzhalter für noch nicht existierende oder externe Komponenten, um die zu testende Einheit isolieren zu können.' },
    ...
    { id: '3.2.2_10', q: 'Warum sollten Tests idealerweise von anderen Personen durchgeführt werden als die Entwicklung/Installation?', a: 'Vermeidung von "Betriebsblindheit" und objektivere Bewertung der Ergebnisse.' },
    ...
    { id: '3.2.3_3', q: 'Erkläre das Ziel der "Äquivalenzklassenbildung".', a: 'Einteilung von Testdaten in Gruppen (Klassen), die vom System gleich behandelt werden. Pro Klasse wird nur ein Testfall benötigt, um den Testaufwand zu reduzieren.' },
    ...
    { id: '3.2.3_7', q: 'Welchen Vorteil bietet the "Grey-Box-Test"?', a: 'Kombination aus beidem: Der Tester hat grobe Kenntnis der Architektur (z.B. Datenbank-Struktur), testet aber über die funktionale Oberfläche.' },
    ...
    { id: '3.2.3_10', q: 'Warum ist die Dokumentation erfolgreicher Tests genauso wichtig wie die von Fehlern?', a: 'Als Beweis für die vertraglich vereinbarte Qualität und zur Nachvollziehbarkeit bei späteren Regressionstests.' },

    // --- 3.2.4 IT-Grundschutz (BSI) & Standards (10 Karten) ---
    { id: '3.2.4_1', q: 'Was ist die Hauptaufgabe des BSI (Bundesamt für Sicherheit in der Informationstechnik)?', a: 'Die Förderung der IT-Sicherheit in Deutschland durch Standards, Beratung und Zertifizierungen (z.B. für Behörden und KRITIS-Betreiber).' },
    { id: '3.2.4_2', q: 'Erkläre das Prinzip des "BSI IT-Grundschutz".', a: 'Ein ganzheitliches Modell zur Absicherung von Institutionen durch die Anwendung standardisierter Sicherheitsmaßnahmen (Bausteine).' },
    { id: '3.2.4_3', q: 'Nenne die drei grundlegenden Schutzziele der IT-Sicherheit.', a: 'Vertraulichkeit (Confidentiality), Integrität (Integrity), Verfügbarkeit (Availability).' },
    ...
    { id: '3.2.4_5', q: 'Was ist ein "Informationsverbund" laut BSI?', a: 'Die Gesamtheit aller infrastrukturellen, organisatorischen, personellen und technischen Komponenten, die der Erfüllung von Aufgaben in einem Bereich dienen.' },
    { id: '3.2.4_6', q: 'Was beschreibt die Norm ISO/IEC 27001?', a: 'Den internationalen Standard für ein Informationssicherheits-Managementsystem (ISMS). Sie ist prozessorientiert und risikobasiert.' },
    { id: '3.2.4_7', q: 'Was versteht man unter "KRITIS"?', a: 'Kritische Infrastrukturen (z.B. Energie, Wasser, Gesundheit, Finanzen), deren Ausfall dramatische Folgen für die Gesellschaft hätte und die deshalb besonders geschützt werden müssen.' },
    ...
    { id: '3.2.4_10', q: 'Warum ist die Sensibilisierung der Mitarbeiter (Security Awareness) Teil des IT-Grundschutzes?', a: 'Weil der Mensch oft das schwächste Glied in der Sicherheitskette ist (Schutz vor Social Engineering, Phishing).' },

    // --- 3.2.5 Risikoanalyse: Matrix & Bewertung (10 Karten) ---
    { id: '3.2.5_1', q: 'Definition von "Risiko" im IT-Kontext?', a: 'Die Kombination aus der Eintrittswahrscheinlichkeit einer Bedrohung und dem daraus resultierenden Schadensausmaß für die Institution.' },
    { id: '3.2.5_2', q: 'Wie funktioniert eine "Risikomatrix"?', a: 'Ein Diagramm mit zwei Achsen (Eintrittswahrscheinlichkeit vs. Schadenshöhe). Risiken werden in die Felder eingetragen, um die Priorität der Gegenmaßnahmen zu bestimmen (z.B. Ampelsystem).' },
    { id: '3.2.5_3', q: 'Was beschreibt der Begriff "Restrisiko"?', a: 'Das Risiko, das nach Umsetzung aller geplanten Sicherheitsmaßnahmen noch verbleibt. Es muss von der Geschäftsführung explizit akzeptiert werden.' },
    { id: '3.2.5_4', q: 'Nenne die vier gängigen Strategien zum Risikomanagement.', a: '1. Risikovermeidung (Ursache eliminieren), 2. Risikoreduktion (Maßnahmen treffen), 3. Risikotransfer (Versicherung), 4. Risikoakzeptanz (Restrisiko tragen).' },
    { id: '3.2.5_5', q: 'Was ist eine "Gefährdung" im Unterschied zu einer "Schwachstelle"?', a: 'Gefährdung: Ein Ereignis, das einen Schaden verursachen kann (z.B. Blitzschlag). Schwachstelle: Eine Sicherheitslücke, die die Schaden erst ermöglicht (z.B. fehlender Blitzschutz).' },
    { id: '3.2.5_6', q: 'Warum ist eine regelmäßige Risikoanalyse notwendig?', a: 'Weil sich Bedrohungslagen (neue Malware) und die eigene IT-Infrastruktur (neue Systeme) ständig ändern.' },
    ...
    { id: '3.2.5_9', q: 'Was ist der Zweck einer "Asset-Inventarisierung" vor der Risikoanalyse?', a: 'Herauszufinden, welche Werte (Hardware, Daten, Prozesse) überhaupt geschützt werden müssen.' },
    { id: '3.2.5_10', q: 'Wer trägt letztlich die Verantwortung für das Risikomanagement im Unternehmen?', a: 'Die Unternehmensleitung (Geschäftsführung/Vorstand).' },

    // --- 3.2.6 Kryptografie: Grundlagen & Verfahren (10 Karten) ---
    { id: '3.2.6_1', q: 'Was zeichnet die symmetrische Verschlüsselung aus?', a: 'Sender und Empfänger nutzen denselben geheimen Schlüssel zum Ver- und Entschlüsseln (z.B. AES).' },
    ...
    { id: '3.2.6_4', q: 'Was ist eine "Hashfunktion"?', a: 'Eine Einwegfunktion, die aus einer beliebig langen Eingabe eine feste Zeichenfolge (Hashwert) erzeugt. Rückrechnung ist unmöglich.' },
    ...
    { id: '3.2.6_6', q: 'Warum ist RSA ein asymmetrisches Verfahren?', a: 'Weil es auf mathematischen Problemen (Primfaktorzerlegung) basiert, die das Berechnen des privaten Schlüssels aus dem öffentlichen Schlüssel praktisch unmöglich machen.' },
    { id: '3.2.6_7', q: 'Was beschreibt der Begriff "Kollision" bei Hashfunktionen?', a: 'Wenn zwei unterschiedliche Eingabedaten denselben Hashwert ergeben (ein Zeichen für eine unsichere Hashfunktion).' },
    ...
    { id: '3.2.6_9', q: 'Was ist der Unterschied zwischen Verschlüsselung und Codierung?', a: 'Verschlüsselung: Geheimhaltung mittels Schlüssel. Codierung: Umwandlung von Daten in ein anderes Format (z.B. Base64) ohne Geheimhaltung.' },
    { id: '3.2.6_10', q: 'Welche Rolle spielen Schlüssellängen (z.B. 256 Bit) für die Sicherheit?', a: 'Je länger der Schlüssel, desto höher der Aufwand für einen Brute-Force-Angriff (exponentieller Anstieg der Kombinationen).' },
    ...
    { id: '3.2.7_2', q: 'Wie wird eine digitale Signatur technisch erstellt?', a: 'Der Sender hasht die Nachricht und verschlüsselt diesen Hashwert mit seinem PRIVATEN Schlüssel.' },
    { id: '3.2.7_3', q: 'Wie prüft der Empfänger eine digitale Signatur?', a: 'Er entschlüsselt die Signatur mit dem ÖFFENTLICHEN Schlüssel des Senders und vergleicht das Ergebnis mit dem selbst berechneten Hash der Nachricht.' },
    { id: '3.2.7_4', q: 'Was ist ein "digitales Zertifikat" (z.B. X.509)?', a: 'Ein elektronischer Datensatz, der die Identität eines Inhabers bestätigt und seinen öffentlichen Schlüssel beglaubigt.' },
    { id: '3.2.7_5', q: 'Welche Aufgabe hat eine "Certificate Authority" (CA)?', a: 'Eine vertrauenswürdige Instanz, die Zertifikate prüft, ausstellt, signiert und deren Gültigkeit verwaltet.' },
    { id: '3.2.7_6', q: 'Wofür steht die Abkürzung PKI?', a: 'Public Key Infrastructure. Ein System zum Erstellen, Verwalten, Verteilen und Widerrufen von digitalen Zertifikaten.' },
    { id: '3.2.7_7', q: 'Was ist eine "CRL" (Certificate Revocation List)?', a: 'Eine Liste gesperrter Zertifikate (Sperrliste), die vor Ablauf ihrer Gültigkeit für ungültig erklärt wurden (z.B. bei Kompromittierung des Schlüssels).' },
    { id: '3.2.7_8', q: 'Was beschreibt the "Vertrauenskette" (Chain of Trust)?', a: 'Die hierarchische Struktur von Zertifikaten, die bei einem Root-Zertifikat einer vertrauenswürdigen CA beginnt.' },
    { id: '3.2.7_9', q: 'Warum warnt der Browser vor "selbstsignierten" Zertifikaten?', a: 'Weil keine unabhängige, vertrauenswürdige CA die Identität des Servers bestätigt hat (Gefahr von MITM-Angriffen).' },
